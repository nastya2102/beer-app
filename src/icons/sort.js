const SortIcon = ({currentSort}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 512 512" enableBackground="new 0 0 512 512" height='25px' width='25px'>
      <g>
        <path
          ...
          fill={currentSort === 'hight' ? 'orange' : 'gray'}/>
        <path
          ...
          fill={currentSort === 'low' ? 'orange' : 'gray'}/>
      </g>
    </svg>
  )
};
